/****** Object:  Database [hkinvestdb01]    Script Date: 5/8/2022 4:49:15 PM ******/
/****** Object:  Schema [SalesLT]    Script Date: 5/8/2022 4:49:15 PM ******/
CREATE SCHEMA [SalesLT]
GO
/****** Object:  UserDefinedDataType [dbo].[AccountNumber]    Script Date: 5/8/2022 4:49:15 PM ******/
CREATE TYPE [dbo].[AccountNumber] FROM [nvarchar](15) NULL
GO
/****** Object:  UserDefinedDataType [dbo].[Flag]    Script Date: 5/8/2022 4:49:15 PM ******/
CREATE TYPE [dbo].[Flag] FROM [bit] NOT NULL
GO
/****** Object:  UserDefinedDataType [dbo].[Name]    Script Date: 5/8/2022 4:49:15 PM ******/
CREATE TYPE [dbo].[Name] FROM [nvarchar](50) NULL
GO
/****** Object:  UserDefinedDataType [dbo].[NameStyle]    Script Date: 5/8/2022 4:49:15 PM ******/
CREATE TYPE [dbo].[NameStyle] FROM [bit] NOT NULL
GO
/****** Object:  UserDefinedDataType [dbo].[OrderNumber]    Script Date: 5/8/2022 4:49:15 PM ******/
CREATE TYPE [dbo].[OrderNumber] FROM [nvarchar](25) NULL
GO
/****** Object:  UserDefinedDataType [dbo].[Phone]    Script Date: 5/8/2022 4:49:15 PM ******/
CREATE TYPE [dbo].[Phone] FROM [nvarchar](25) NULL
GO
/****** Object:  Sequence [SalesLT].[SalesOrderNumber]    Script Date: 5/8/2022 4:49:15 PM ******/
CREATE SEQUENCE [SalesLT].[SalesOrderNumber] 
 ...
 CACHE 
GO
/****** Object:  UserDefinedFunction [dbo].[ufnGetAllCategories]    Script Date: 5/8/2022 4:49:15 PM ******/
SET ANSI_NULLS ON
GO
...
END;
GO
/****** Object:  UserDefinedFunction [dbo].[ufnGetSalesOrderStatusText]    Script Date: 5/8/2022 4:49:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  Table [SalesLT].[Customer]    Script Date: 5/8/2022 4:49:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[ufnGetCustomerInformation]    Script Date: 5/8/2022 4:49:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [SalesLT].[ProductModel]    Script Date: 5/8/2022 4:49:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [SalesLT].[vProductModelCatalogDescription]    Script Date: 5/8/2022 4:49:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [SalesLT].[ProductDescription]    Script Date: 5/8/2022 4:49:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [SalesLT].[Product]    Script Date: 5/8/2022 4:49:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [SalesLT].[ProductModelProductDescription]    Script Date: 5/8/2022 4:49:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [SalesLT].[vProductAndDescription]    Script Date: 5/8/2022 4:49:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Index [IX_vProductAndDescription]    Script Date: 5/8/2022 4:49:15 PM ******/
...
GO
/****** Object:  Table [SalesLT].[ProductCategory]    Script Date: 5/8/2022 4:49:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [SalesLT].[vGetAllCategories]    Script Date: 5/8/2022 4:49:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
ON PC.[ProductCategoryID] = CCTE.[ParentProductCategoryID]
GO
/****** Object:  Table [dbo].[BuildVersion]    Script Date: 5/8/2022 4:49:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ErrorLog]    Script Date: 5/8/2022 4:49:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[T_FLAG]    Script Date: 5/8/2022 4:49:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[T_FLAG](
	[Medal] [numeric](15, 3) NULL,
	[Flag1] [nchar](10) NULL,
	[Flag2] [nchar](10) NULL,
	[Flag3] [nchar](10) NULL,
	[Flag4] [nchar](10) NULL,
...
GO
/****** Object:  Table [dbo].[TableMedal]    Script Date: 5/8/2022 4:49:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[TableMedal](
	[Medal] [numeric](15, 3) NULL,
	[Flag1] [nchar](10) NULL,
	[Flag2] [nchar](10) NULL,
	[Flag3] [nchar](10) NULL,
...
GO
/****** Object:  Table [SalesLT].[Address]    Script Date: 5/8/2022 4:49:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [SalesLT].[CustomerAddress]    Script Date: 5/8/2022 4:49:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [SalesLT].[PipelineExecution]    Script Date: 5/8/2022 4:49:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [SalesLT].[PipelineExecution](
	[RunSeqNo] [int] IDENTITY(1,1) NOT NULL,
...
GO
/****** Object:  Table [SalesLT].[Sales_LOAD]    Script Date: 5/8/2022 4:49:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [SalesLT].[Sales_LOAD](
	...
	[RunSeqNo] [int] NULL,
 CONSTRAINT [PK__SalesLT_Sales_LOAD] PRIMARY KEY CLUSTERED 
(
	[RowId] ASC
)WITH (STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [SalesLT].[SalesOrderDetail]    Script Date: 5/8/2022 4:49:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [SalesLT].[SalesOrderHeader]    Script Date: 5/8/2022 4:49:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [IX_Address_AddressLine1_AddressLine2_City_StateProvince_PostalCode_CountryRegion]    Script Date: 5/8/2022 4:49:15 PM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [IX_Address_StateProvince]    Script Date: 5/8/2022 4:49:15 PM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [IX_Customer_EmailAddress]    Script Date: 5/8/2022 4:49:15 PM ******/
CREATE NONCLUSTERED INDEX [IX_Customer_EmailAddress] ON [SalesLT].[Customer]
(
	[EmailAddress] ASC
)WITH (STATISTICS_NORECOMPUTE = OFF, DROP_EXISTING = OFF, ONLINE = OFF) ON [PRIMARY]
GO
/****** Object:  Index [IX_SalesOrderDetail_ProductID]    Script Date: 5/8/2022 4:49:15 PM ******/
CREATE NONCLUSTERED INDEX [IX_SalesOrderDetail_ProductID] ON [SalesLT].[SalesOrderDetail]
(
	[ProductID] ASC
)WITH (STATISTICS_NORECOMPUTE = OFF, DROP_EXISTING = OFF, ONLINE = OFF) ON [PRIMARY]
GO
/****** Object:  Index [IX_SalesOrderHeader_CustomerID]    Script Date: 5/8/2022 4:49:15 PM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[uspLogError]    Script Date: 5/8/2022 4:49:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [dbo].[uspPrintError]    Script Date: 5/8/2022 4:49:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [SalesLT].[LogPipelineEnd]    Script Date: 5/8/2022 4:49:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [SalesLT].[LogPipelineEnd] (
@RunSeqNo INT
...
UPDATE [SalesLT].PipelineExecution
...
GO
/****** Object:  StoredProcedure [SalesLT].[LogPipelineExecution]    Script Date: 5/8/2022 4:49:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [SalesLT].[LogPipelineExecution] (
...
INSERT INTO [SalesLT].PipelineExecution (
PipelineRunId
, RunEndDateTime
, FilesRead
, RowsRead
...
GO
/****** Object:  StoredProcedure [SalesLT].[LogPipelineStart]    Script Date: 5/8/2022 4:49:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [SalesLT].[LogPipelineStart] (
@PipelineRunId UNIQUEIDENTIFIER
...
GO
ALTER DATABASE [hkinvestdb01] SET  READ_WRITE 
GO
